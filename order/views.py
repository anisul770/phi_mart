...
class OrderViewSet(ModelViewSet):
    ...
    # permission_classes doesn't work in action if we override the permission_class
...
def initiate_payment(request):
  ...
  settings = { 'store_id':'phima699d02b240d0f', 'store_pass': 'phima699d02b240d0f@ssl', 'issandbox': True }
